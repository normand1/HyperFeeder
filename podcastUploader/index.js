...
async function postEpisode(youtubeVideoInfo) {
  console.log('Starting to post episode');
  console.log(youtubeVideoInfo);
  const { audioFilePath, podcastTitle, podcastDescription } = JSON.parse(youtubeVideoInfo);
  let browser;
  try {
    ...
    */
    ...
    await page.type('#title', podcastTitle);

    console.log('-- Adding description');
    await page.waitForSelector('div[role="textbox"]', { visible: true });
    await page.type('div[role="textbox"]', podcastDescription);
