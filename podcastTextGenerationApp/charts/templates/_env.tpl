...
{{- $segmentWriterPlugins := list -}}

{{- if .Values.GENERIC_THREAD_WRITER_PLUGINS }}
  {{- range .Values.GENERIC_THREAD_WRITER_PLUGINS }}
    {{- $segmentWriterPlugins = append $segmentWriterPlugins . }}
  {{- end }}
{{- end }}

{{- if .Values.GENERIC_NEWS_PODCAST_SEGMENT_WRITER }}
  {{- range .Values.GENERIC_NEWS_PODCAST_SEGMENT_WRITER }}
    {{- $segmentWriterPlugins = append $segmentWriterPlugins . }}
  {{- end }}
{{- end }}
...
PODCAST_SEGMENT_WRITER_PLUGINS="{{ join "," $segmentWriterPlugins }}"
...
TWEET_THREAD_WRITER_SYSTEM_PROMPT_SUMMARY={{- .Values.TWEET_THREAD_WRITER_SYSTEM_PROMPT_SUMMARY | quote }}
TWEET_THREAD_WRITER_USER_PROMPT_SUMMARY={{- .Values.TWEET_THREAD_WRITER_USER_PROMPT_SUMMARY | quote }}
...
MAX_FOLLOW_UP_QUESTIONS={{ .Values.MAX_FOLLOW_UP_QUESTIONS }}
