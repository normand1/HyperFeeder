...
class TesterDataSourcePlugin(BaseDataSourcePlugin):
    ...
    def fetchStories(self):
        ...
        story1 = Story(1, 'Test Story 1', 'https://www.google.com?=1', 'Test Story Type', '123', 'Test Source')
        story2 = Story(2, 'Test Story 2', 'https://www.google.com?=2', 'Test Story Type', '124', 'Test Source')
        story3 = Story(3, 'Test Story 3', 'https://www.google.com?=3', 'Test Story Type', '125', 'Test Source')
