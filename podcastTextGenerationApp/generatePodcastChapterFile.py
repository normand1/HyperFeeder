...
if len(sys.argv) < 2:
    print("Please provide the path to the folder containing your mp3 files as a command line argument.")
    sys.exit(1)
...
mp3_files = sorted([f for f in os.listdir(audio_folder_path) if f.endswith('.mp3')], key=lambda x: os.path.splitext(x)[0])
